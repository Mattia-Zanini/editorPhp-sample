...
function load_js()
{
	...
	wp_enqueue_script('buttons', get_template_directory_uri() . "/js/default/buttons.bootstrap5.js", array(), '2.3.3', true);
	...
	wp_enqueue_script('editor_pippo', "/Editor/js/dataTables.editor.min.js", array(), '2.0.10', true);
	wp_enqueue_script('editor_bootstrap5', "/Editor/js/editor.bootstrap5.min.js", array(), '2.0.10', true);
}
